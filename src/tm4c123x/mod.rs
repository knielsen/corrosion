...
// These are the addresses for the APB bus.
    pub const GPIO_PORTA_BASE: uint = 0x40004000;
    pub const GPIO_PORTB_BASE: uint = 0x40005000;
    pub const GPIO_PORTC_BASE: uint = 0x40006000;
    pub const GPIO_PORTD_BASE: uint = 0x40007000;
    pub const GPIO_PORTE_BASE: uint = 0x40024000;
    pub const GPIO_PORTF_BASE: uint = 0x40025000;
    pub const GPIO_PORTG_BASE: uint = 0x40026000;
    pub const GPIO_PORTH_BASE: uint = 0x40027000;
	...
	let gpio_num =
	    if port >= GPIO_PORTE_BASE {
              4 + ((port - GPIO_PORTE_BASE) >> 12)
	    } else {
              (port - GPIO_PORTA_BASE) >> 12
	    };
